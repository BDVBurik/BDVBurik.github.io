(function () {
  ...
  function otzyv_kp_imdb(kpid, imdbid, num) {
    $.get(
      ...
      function (data) {
        var modal = $(
          '<div><div class="broadcast__text" style="text-align:left"><div class="otzyv">' +
            data +
            "</div></div></div>"
        );
