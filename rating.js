(function () { //спижжено и порезано...  рейтинг имдб для лампа 
	'use strict';
	...
	function rating_kp_imdb(card) {
		...
		var kp_prox = 'https://cors.kp556.workers.dev:8443/';// 'https://cors.bdvburik.workers.dev/corsproxy/?apiurl=';// ; // хуй знает сколько єтот проксі проработает
		var params = {
			id: card.id,
