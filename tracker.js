...
function changeParser() {
     ...
     if (Lampa.Storage.get('jackett_url_two') == 'jac_110_18') 	Lampa.Storage.set('jackett_url', '192.168.1.110:9118')&Lampa.Storage.set('jackett_key', '1')&Lampa.Storage.set('jackett_interview','all')&Lampa.Storage.set('parse_in_search', true)&Lampa.Storage.set('parse_lang', 'lg');
     if (Lampa.Storage.get('jackett_url_two') == 'jac_110_17') 	Lampa.Storage.set('jackett_url', '192.168.1.110:9117')&Lampa.Storage.set('jackett_key', '7wewegwjfxn750vi23t4kr0fz8h9bmfd')&Lampa.Storage.set('jackett_interview','all')&Lampa.Storage.set('parse_in_search', true)&Lampa.Storage.set('parse_lang', 'lg');
