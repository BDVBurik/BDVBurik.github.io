(function () {
  ...
  function myRequest(i) {
    setTimeout(function () {
      ...
      if (parserBase[i] == "spawn.pp.ua:59117")
        var myAdder =
          "2&Query=Rebel%20Moon%20-%20Part%20One%3A%20A%20Child%20of%20Fire&title=%D0%9C%D1%8F%D1%82%D0%B5%D0%B6%D0%BD%D0%B0%D1%8F%20%D0%9B%D1%83%D0%BD%D0%B0%2C%20%D1%87%D0%B0%D1%81%D1%82%D1%8C%201%3A%20%D0%94%D0%B8%D1%82%D1%8F%20%D0%BE%D0%B3%D0%BD%D1%8F&title_original=Rebel%20Moon%20-%20Part%20One%3A%20A%20Child%20of%20Fire&year=2023&is_serial=1&genres=%D1%84%D0%B0%D0%BD%D1%82%D0%B0%D1%81%D1%82%D0%B8%D0%BA%D0%B0%2C%D0%B1%D0%BE%D0%B5%D0%B2%D0%B8%D0%BA%2C%D0%BF%D1%80%D0%B8%D0%BA%D0%BB%D1%8E%D1%87%D0%B5%D0%BD%D0%B8%D1%8F&Category[]=2000";
      var k = i + 2;
      var mySelector =
  ...
  function changeParser() {
    ...
    if (Lampa.Storage.get("jackett_url_two") == "jac_110_18")
      Lampa.Storage.set("jackett_url", "192.168.1.110:9118") &
        Lampa.Storage.set("jackett_key", "1") &
        Lampa.Storage.set("jackett_interview", "all") &
        Lampa.Storage.set("parse_in_search", true) &
        Lampa.Storage.set("parse_lang", "lg");
    if (Lampa.Storage.get("jackett_url_two") == "jac_110_17")
      Lampa.Storage.set("jackett_url", "192.168.1.110:9117") &
        Lampa.Storage.set("jackett_key", "jackett") &
        Lampa.Storage.set("jackett_interview", "all") &
        Lampa.Storage.set("parse_in_search", true) &
        Lampa.Storage.set("parse_lang", "lg");
    if (Lampa.Storage.get("jackett_url_two") == "jac_lampa32_ru")
      Lampa.Storage.set("jackett_url", "jac.lampa32.ru") &
        Lampa.Storage.set("jackett_key", "") &
        Lampa.Storage.set("jackett_interview", "all") &
        Lampa.Storage.set("parse_in_search", true) &
        Lampa.Storage.set("parse_lang", "lg");
    if (Lampa.Storage.get("jackett_url_two") == "spawn_jacred")
      Lampa.Storage.set("jackett_url", "spawn.pp.ua:59118") &
        Lampa.Storage.set("jackett_key", "") &
        Lampa.Storage.set("jackett_interview", "all") &
        Lampa.Storage.set("parse_in_search", true) &
        Lampa.Storage.set("parse_lang", "lg");
    if (Lampa.Storage.get("jackett_url_two") == "jacred_xyz")
      Lampa.Storage.set("jackett_url", "jacred.xyz") &
        Lampa.Storage.set("jackett_key", "") &
        Lampa.Storage.set("jackett_interview", "all") &
        Lampa.Storage.set("parse_in_search", true) &
        Lampa.Storage.set("parse_lang", "lg");
    if (Lampa.Storage.get("jackett_url_two") == "spawn_jackett")
    ...
    if (Lampa.Storage.get("jackett_url_two") == "jacred_ru")
      Lampa.Storage.set("jackett_url", "jacred.ru") &
        Lampa.Storage.set("jackett_key", "") &
        Lampa.Storage.set("jackett_interview", "all") &
        Lampa.Storage.set("parse_in_search", true) &
        Lampa.Storage.set("parse_lang", "lg");
    if (Lampa.Storage.get("jackett_url_two") == "unknown")
      Lampa.Storage.set("jackett_url", "188.119.113.252:9117") &
        Lampa.Storage.set("jackett_key", "1") &
        Lampa.Storage.set("jackett_interview", "all") &
        Lampa.Storage.set("parse_in_search", true) &
        Lampa.Storage.set("parse_lang", "lg");
    ...
    if (Lampa.Storage.get("jackett_url_two") == "jacred_viewbox_dev")
  ...
  Lampa.SettingsApi.addParam({
    ...
    param: {
      ...
      type: "select",
      values: {
        jac_110_18: "jac_110_18",
        jac_110_17: "jac_110_17",
        no_parser: "Не выбран",
      ...
      setTimeout(function () {
        ...
        if (Lampa.Storage.field("parser_use"))
          item.show() &
            ...
            $('div[data-name="jackett_url_two"]').insertAfter(
